...
module.exports = config => {
  ...
  const fn = type => params =>
    request
      .get(url(Object.assign({}, params, { function: type })), { resolveWithFullResponse: true, simple: false, ...config.requestOpts })
      .then(response => {
      ...
      .catch(function (err) {
        throw `An AlphaVantage error occurred. ${err.message}`;
      });
